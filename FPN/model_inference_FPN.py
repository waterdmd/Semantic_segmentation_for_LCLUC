...
model_path = '/data/models/J+D/FPN/FPN_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/Seasonal/FPN/FPN_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/yearly_mean/FPN/FPN_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/RGB/FPN/FPN_epochs_200_crossentropy_state_dict.pth'
#%% Load weights
EPOCHS = 200
