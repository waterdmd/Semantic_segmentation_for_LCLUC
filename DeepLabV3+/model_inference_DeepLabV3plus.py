...
# model_path = '/data/models/J+D/DeepLab/DeepLabV3Plus_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/Seasonal/DeepLab/DeepLabv3+_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/yearly_mean/Deeplab/DeepLabV3Plus_epochs_200_crossentropy_state_dict.pth'
model_path = '/data/models/RGB/DeepLab/DeepLabV3Plus_epochs_200_crossentropy_state_dict.pth'
#%% Load weights
EPOCHS = 200
