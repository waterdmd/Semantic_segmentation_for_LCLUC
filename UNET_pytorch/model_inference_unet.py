...
model_path = '/data/models/J+D/Unet_pytorch/UNET_epochs_100_crossentropy_state_dict.pth'
# model_path = '/data/models/Seasonal/Unet_pytorch/UNET_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/yearly_mean/UNET/UNET_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/RGB/UNET/UNET_epochs_200_crossentropy_state_dict.pth'
#%% Load weights
EPOCHS = 200
