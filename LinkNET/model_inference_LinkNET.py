...
# model_path = '/data/models/J+D/LinkNet/LinkNet_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/Seasonal/LinkNet/LinkNet_epochs_200_crossentropy_state_dict.pth'
# model_path = '/data/models/yearly_mean/LinkNET/LinkNet_epochs_200_crossentropy_state_dict.pth'
model_path = '/data/models/RGB/LinkNet/LinkNet_epochs_200_crossentropy_state_dict.pth'
#%% Load weights
EPOCHS = 200
