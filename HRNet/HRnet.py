...
# class HighResolutionNetCustom(nn.Module):
#     def __init__(self, config, input_channels, **kwargs):
#         global ALIGN_CORNERS
#         extra = config.MODEL.EXTRA
#         super(HighResolutionNetCustom, self).__init__()
...
# def get_hrnet_model(cfg, input_channels, **kwargs):
#     model = HighResolutionNetCustom(cfg, input_channels, **kwargs)
...
class HighResolutionNetCustom(nn.Module):
    ...
    def forward(self, x):
        ...
        # Ensure the final output is upsampled to match input size
        main_output = F.interpolate(out, size=(64, 64), mode='bilinear', align_corners=ALIGN_CORNERS)
